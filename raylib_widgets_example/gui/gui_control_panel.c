...
void gui_control_panel(OscData *oscData, int screenWidth, int screenHeight) {
    ...
    Gui_CamSwitch_Channel(1, Terminus12x6_font, TerminusBold18x10_font,
                     sliderX + 234, sliderY,
                     "Vertical\noffset",
    ...
    // Рівень тригера
    Gui_CamSwitch_Channel(2, Terminus12x6_font, TerminusBold18x10_font,
                     sliderX + 65, sliderY,
                     "Trigger\nlevel",
    ...
    // Рівень гістерезису
    Gui_CamSwitch_Channel(3, Terminus12x6_font, TerminusBold18x10_font,
                     sliderX + 234, sliderY,
                     "Trigger\nhysteresis",
    ...
    Gui_CamSwitch_Channel(4, Terminus12x6_font, TerminusBold18x10_font,
                     sliderX + 65, sliderY,
                     "Refresh\nRate (ms)",
