...
Slider sliders[] = {
  {{WIDTH_RAY +  4, MIN_Y_BORDER, SLIDER_WIDTH/2, Y_WORKSPACE}, 0.5f, &scroll_y_a, true, false},    // Лівий вертикальний повзунок
  {{WIDTH_RAY + 20, MIN_Y_BORDER, SLIDER_WIDTH/2, Y_WORKSPACE}, 0.5f, &scroll_y_b, true, false},    // Правий вертикальний повзунок
  {{BEGIN_RAY, 12, X_WORKSPACE, SLIDER_WIDTH}, 0.5f, &scroll_x_a, false, false},     // Верхній горизонтальний повзунок
  {{BEGIN_RAY, HEIGHT - 28, X_WORKSPACE, SLIDER_WIDTH}, 0.5f, &scroll_x_b, false, false},    // Нижній горизонтальний повзунок
  {{12, MIN_Y_BORDER, SLIDER_WIDTH/2, Y_WORKSPACE}, 0.5f, &trigger_a, true, false}  // Вертикальний повзунок тригера
};
