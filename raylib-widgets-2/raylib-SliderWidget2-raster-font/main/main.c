...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        RegisterSlider(0, sliderBounds, &values[0], 250.0f, -250.0f, true, YELLOW, "tLeft1", NULL);
        RegisterSlider(1, sliderBounds, &values[1], 250.0f, -250.0f, true, GREEN, "tLeft2", "tRight2");
        RegisterSlider(2, sliderBounds, &values[2], 250.0f, -250.0f, true, RED, "tLeft3", "tRight3");
        RegisterSlider(3, sliderBounds, &values[3], 250.0f, -250.0f, true, SKYBLUE, "tLeft4", "tRight4");
