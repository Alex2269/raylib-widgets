...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        Gui_SliderKnobCircle(0, sliderBounds, TerminusBold18x10_font, 2, "tLeft1", NULL, &values[0], 250.0f, -250.0f, true, YELLOW);
        Gui_SliderKnobCircle(1, sliderBounds, TerminusBold18x10_font, 2, "tLeft2", "tRight2", &values[1], -250.0f, 250.0f, true, GREEN);
        Gui_SliderKnobCircle(2, sliderBounds, TerminusBold18x10_font, 2, "tLeft3", "tRight3", &values[2], 250.0f, -250.0f, true, RED);
        Gui_SliderKnobCircle(3, sliderBounds, TerminusBold18x10_font, 2, "tLeft4", "tRight4", &values[3], -250.0f, 250.0f, true, SKYBLUE);
