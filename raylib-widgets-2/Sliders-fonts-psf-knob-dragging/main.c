...
void UpdateDrawFrame(void) {
    ...
    Gui_Slider(slider_vertical, font18, "Vertical", "Vertical", &sliderValue1, 0.0f, 100.0f, true, DARKGRAY);

    Rectangle slider_horizontal = { 200, 250, 300, 20 };
    Gui_Slider(slider_horizontal, font18, "Horizontal", NULL, &sliderValue2, 0.0f, 100.0f, false, DARKGRAY);
